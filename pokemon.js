...
const viewByName = pokemon.map((pokemon) => pokemon.name)
    console.log(viewByName)

const viewByDescription = pokemon.map((pokemon) => pokemon.description)
    console.log(viewByDescription)

const viewByType = pokemon.map((pokemon) => pokemon.types)
    console.log(viewByType)
