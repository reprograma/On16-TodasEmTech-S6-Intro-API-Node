...
//EXTRA 03: No filmes.js apresente titulo, plot, generos e lingua. 
// Genero e lingua devem ser apresentados em arrays no console.

const inputTitulo = obj.map((nome) => nome.Title)
//console.table(inputTitulo)
const inputPlot = obj.map((descricao) => descricao.Plot)
//console.table(inputPlot)
const inputGenero = obj.map((genero) => genero.Genre)
//console.log(inputGenero)
const inputIdioma = obj.map((idioma) => idioma.Language)
//console.log(inputIdioma)
