...
// FAÇA O EXERCÍCIO ABAIXO
    ...
    /*const poke = JSON.parse(JSON.stringify(data))
    for (let index = 0; index < poke.length; index++) {
        console.log("--------------------------Pokemon nº" + (index + 1) + "--------------------------")
        console.log("Nome: " + poke[index].nome +  "\n" + "Descrição: " + poke[index].description +  "\n" + "Tipo(s): " + poke[index].types)
    }*/