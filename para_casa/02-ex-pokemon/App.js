...
const listarPokemons = () => {
    ...
    const listaPokemons = pokemons.map(pokemon => console.log("o nome do pokemon é: " + pokemon.name + "\n" + "a descrição do pokemon é: " + pokemon.description + "\n" + pokemon.art_url + "\n" + "O tipo de " + pokemon.name + " é: " + pokemon.types + "\n" + "__________________" + "\n"))
}
